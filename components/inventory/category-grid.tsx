...
import type { CategoryWithCount, Cluster } from '@/lib/types'
...
export function CategoryGrid({ categories, totalDevices, canAdd }: CategoryGridProps) {
  ...
  return (
    <div className="max-w-[1280px] mx-auto space-y-[18px]">
      ...
      <Link href="/inventory?category=all" className="block group">
        <div className="rounded-kb border border-[var(--rule)] bg-gradient-to-br from-[var(--blue-tint)] to-white p-[18px] shadow-xs transition-all hover:shadow-md hover:border-[var(--blue-line)]">
